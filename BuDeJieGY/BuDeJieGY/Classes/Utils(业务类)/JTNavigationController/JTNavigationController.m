...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    NSString *backButtonTitle = viewController.jt_navigationController.backButtonTitle;

    UIButton *btn = [UIButton buttonWithType:UIButtonTypeCustom];
    btn.titleLabel.font = [UIFont italicSystemFontOfSize:16];
    [btn setTitle:backButtonTitle forState:UIControlStateNormal];
